                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="submitData" class=" space-y-3">
                        <div>
                            ...
                            <input @blur="ClearValidation('arName')" type="text" name="email" id="fullNdame"
                                ...
                                placeholder="eg . ahmed gamal" v-model.trim="arName.val" required="">
                        ...
                        <div>
                            ...
                            <input @blur="ClearValidation('enName')" type="text" name="email" id="fuldlNagme"
                                class="bg-gray-50 border border-gray-300  sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="eg . ahmed gamal" v-model.trim="enName.val" required="">
                        ...
                        <div>
                            ...
                            <input type="text" name="email" id="fullNdeame"
                                class="bg-gray-50 border border-gray-300  sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="eg . ahmed gamal" v-model.trim="userName.val" required="">


                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium">البريد الالكترونى</label>
                            <input @blur="ClearValidation('email')" type="email" name="email" id="email"
                                class="bg-gray-50 border border-gray-300  sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="name@company.com" v-model.trim="email.val" required="">
                        ...
                        <div>
                            ...
                            <input @blur="ClearValidation('pass')" type="password" name="password" id="password"
                                placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                v-model.trim="pass.val" required="">
                            <p class=" text-red-800 py-2 font-bold mx-3" v-if="!pass.valid">{{ pass.error }}</p>


                        </div>
                        <div>
                            <label for="confirm-password" class="block mb-2 text-sm font-mediumdark:text-white">تاكيد كلمة
                                المرور </label>
                            <input @blur="ClearValidation('confirmPass')" type="password" name="confirm-password"
                                id="confirm-password" placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                v-model.trim="confirmPass.val" required="">
                            <p class=" text-red-800 py-2 font-bold mx-3" v-if="!confirmPass.valid">{{ confirmPass.error }}
                            </p>
                        </div>
                        <!-- 
                  <div class="flex items-start">
                        ...
                        <button type="submit"
                            class="w-full bg-white text-[#313A49] bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">انشاء
                            حساب</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            املك جساب بالفعل? <button @click="$emit('ToggleMood')"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500">تسجيل الدخول
                            </button>
                        </p>
                    </form>
                </div>
...
<style lang="scss" scoped>.mainForm {
